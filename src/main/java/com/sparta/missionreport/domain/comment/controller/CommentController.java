...
public class CommentController {
    ...
    public ResponseEntity<CommonResponseDto> createComment(@AuthenticationPrincipal UserDetailsImpl userDetails,
        ...
        CommentDto.CommentResponse response = commentService.createComment(userDetails.getUser(), card_id, request);
    ...
    public ResponseEntity<CommonResponseDto> updateComment(@AuthenticationPrincipal UserDetailsImpl userDetails,
        ...
        CommentDto.CommentResponse response = commentService.updateComment(userDetails.getUser(), comment_id, request);
    ...
    public ResponseEntity<CommonResponseDto> getCommentsInCard(@AuthenticationPrincipal UserDetailsImpl userDetails,
                                                           @PathVariable Long card_id
    ) {
        List<CommentDto.CommentResponse> responses =  commentService.getCommentsInCard(userDetails.getUser(), card_id);
        return ResponseEntity.status(HttpStatus.OK).body(
    ...
    public ResponseEntity<CommonResponseDto> getComment(@AuthenticationPrincipal UserDetailsImpl userDetails,
                                                               @PathVariable Long comment_id
    ) {
        CommentDto.CommentResponse response =  commentService.getComment(userDetails.getUser(), comment_id);
        return ResponseEntity.status(HttpStatus.OK).body(
